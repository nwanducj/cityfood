  ...
  <div>
    <div class="header">
      ...
      <div class="head__privacy d-flex align-items-center pa-2">
        ...
        <div class="secondary--text font-weight-bold mx-auto">
          Terms of Service
        </div>
      </div>
    </div>
    <div class="privacy">
      ...
      <div class="privacy__text">
        ...
        of Use; (2) you are not a minor in the jurisdiction in which you reside;
        ...
        <br />
        <br />
        PRODUCTS We make every effort to display as accurately as possible the
        colours, features, specifications, and details of the products available
        on the Site. However, we do not guarantee that the colours, features,
        ...
        <br />
        <br />
        PURCHASES AND PAYMENT We accept the following forms of payment:
      </div>
      <div class="line"></div>
      <div class="text-center">
        <v-btn class="rounded-lg text-none" color="primary"
          >Download Terms of Service</v-btn
        >
      </div>
    </div>
    <Footer />
