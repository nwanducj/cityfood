<template>
  <div>
    <div class="header">
      <div class="d-flex align-center ml-sm-16 py-4">
        <img class="icon" src="~assets/img/cityfoodpng 1.png" />
        <img class="cityfood" src="~assets/img/cityfoodpng 2.png" />
      </div>
      <div class="head__privacy d-flex pa-2 align-center">
        <div @click="$router.go(-1)" class="mt-2 ml-2 ml-sm-16">
          <svg
            width="23"
            height="20"
            viewBox="0 0 73 67"
          ...
          >
            <g filter="url(#filter0_d)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M30.75 3.25003C30.7506 2.70258 30.5636 2.16868 30.2154 1.72304C29.8671 1.2774 29.375 0.942319 28.8079 0.764694C28.2407 0.58707 27.6269 0.575789 27.0524 0.732429C26.4779 0.88907 25.9714 1.20579 25.6038 1.63828L5.47879 25.2633C5.0862 25.7241 4.87305 26.2912 4.87305 26.875C4.87305 27.4588 5.0862 28.026 5.47879 28.4868L25.6038 52.1118C25.9714 52.5443 26.4779 52.861 27.0524 53.0176C27.6269 53.1743 28.2407 53.163 28.8079 52.9854C29.375 52.8077 29.8671 52.4727 30.2154 52.027C30.5636 51.5814 30.7506 51.0475 30.75 50.5V40.0263C46.2147 40.3203 53.6437 43.0004 57.3754 45.9142C60.9232 48.6835 61.5729 51.9412 62.2485 55.3537L62.4239 56.233C62.5529 56.8623 62.9293 57.4268 63.4823 57.8203C64.0353 58.2139 64.7267 58.4094 65.4265 58.37C66.1264 58.3307 66.7863 58.0592 67.2822 57.6067C67.7781 57.1541 68.0758 56.5517 68.1193 55.9128C68.6109 48.6993 67.872 38.2465 62.2917 29.5027C56.8752 21.016 47.1203 14.4903 30.75 13.8078V3.25003Z"
                fill="#45484A"
                fill-opacity="0.8"
        ...
        <div
          class="secondary--text font-weight-bold mx-auto mt-1 privacy__texth"
        >
          Privacy Policy
        </div>
      </div>
    ...
    <div class="privacy">
      ...
      <div class="privacy__text">
        Thank you for choosing to be part of our community at CityFood LLC
        ...
        include the following: Personal Information Provided by You. We collect
        names; phone numbers; email addresses; usernames; passwords; contact
        preferences; debit/credit card numbers; and other similar information.
        ...
        instrument. All payment data is stored by Flutterwave. You may find
        their privacy notice link(s) here:

        <a>https://flutterwave.com/us/privacy-policy</a>
        ...
        'crash dumps') and hardware settings). Device Data. We collect device
        ...
        aspects of the Services. Information collected through our App In Short:
        We collect information regarding your geolocation, push notifications,
        when you use our App. If you use our App, we also collect the following
        information:
        <br />
        ...
        permissions, you may do so in your device's settings. <br /> Push
        ...
        2. HOW DO WE USE YOUR INFORMATION? In Short: We process your information
        for purposes based on legitimate business interests, the fulfilment of
        our contract with you, compliance with our legal obligations, and/or
        your consent. We use personal information collected via our Services for
        a variety of business purposes described below. We process your personal
        ...
        info.cityfood@gmail.com and be sure to include your name, testimonial
        ...
        to administer prize draws and competitions when you elect to participate
        in our competitions.
        <br />
        ...
        <br />In Short: We only share information with your consent, to comply
        with laws, to provide you with services, to protect your rights, or to
        fulfil business obligations. We may process or share your data that we
        ...
        <br /> Google Maps Platform APIs. We may share your information with
        certain Google Maps Platform APIs (e.g., Google Maps API, Place API). To
        find out more about Google’s Privacy Policy, please refer to this link.
        ...
        <br /> Offer Wall. Our App may display a third-party hosted "offer
        ...
        may appear in our App and be displayed to you based on certain data,
        such as your geographic area or demographic information. When you click
        on an offer wall, you will be brought to an external website belonging
        to other persons and will leave our App. A unique identifier, such as
        ...
        Please note that we do not control third-party websites and have no
        responsibility in relation to the content of such websites. The
        inclusion of a link towards a third-party website does not imply an
        endorsement by us of such website. Accordingly, we do not make any
        warranty regarding such third-party websites and we will not be liable
        for any loss or damage caused by the use of such websites. In addition,
        when you access any third-party website, please understand that your
        rights while accessing and using those websites will be governed by the
        ...
        5. HOW DO WE HANDLE YOUR SOCIAL LOGINS? <br />In Short: If you choose to
        register or log in to our services using a social media account, we may
        have access to certain information about you. Our Services offers you
        the ability to register and login using your third-party social media
        account details (like your Facebook or Twitter logins). Where you choose
        ...
        depending on the social media provider concerned, but will often include
        your name, email address, friends list, profile picture as well as other
        information you choose to make public on such social media platform. We
        ...
        <br /><br />8. DO WE COLLECT INFORMATION FROM MINORS?<br />
        ...
        to children under 18 years of age. By using the Services, you represent
        ...
        aware
        <br />
        of any data we may have collected from children under age 18, please
        contact us at <a>info.cityfood@gmail.com</a>.
        ...
        <a>https://www.edoeb.admin.ch/edoeb/en/home.html</a>. If you have
        questions or comments about your privacy rights, you may email us at
        info.cityfood@gmail.com. Account Information If you would at any time
        ...
        <a>http://www.aboutads.info/choices/</a>. Opting out of email marketing:
        ...
        may: <br /> Access your account settings and update your preferences.

        <br /><br />
        10. CONTROLS FOR DO-NOT-TRACK FEATURES <br />Most web browsers and some
        ...
        <br /><br />
        11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS? <br />In
        ...
        unwanted data that you publicly post on the Services.<br />
        ...
        <br /><br />
        13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE? <br />If you have
        questions or comments about this notice, you may email us at
        info.cityfood@gmail.com or by post to: CityFood LLC Enugu, Nigeria
        Enugu, Enugu 400102 Nigeria.
